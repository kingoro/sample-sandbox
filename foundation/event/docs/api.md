...
| `utility_event_trace_log.h` | trace recordのLog Foundation adapter |
...
Event FoundationはPool実装、handle bit layout、arena、OSを認識しない。
...
| `ut_event_trace_log_sink` | trace recordをLog Foundationへ出力 |
